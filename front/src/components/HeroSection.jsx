    ...
    return (
        <section className="relative min-h-screen flex flex-col mt-10 md:mt-15 md:ml-45 md:mr-45">
            <div className="flex flex-col items-center mb-20">
                <span className="rotate-3 md:mb-5 z-10 px-4 md:px-10 py-1 bg-minecraft-green text-black text-[30px] md:text-[60px] font-bold rounded-sm uppercase font-title">
                    Nouveau
                </span>
            ...
            <div className="w-full mb-10">
                ...
                <Carousel items={cards} className="md:hidden" />
            </div>
            ...
            <div className="flex flex-col items-center md:bottom-10 md:flex-row md:gap-10 lg:justify-between">
                <img
                    src={carte1}
                    alt="Carte 1"
                    className="w-75 mt-10 rounded-lg"
                />
                <img
                    src={carte2}
                    alt="Carte 2"
